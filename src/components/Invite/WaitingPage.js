      ...
      return(
        <div style={{margin: '2rem 0 1rem 0'}}>
         ...
         <i className="fa fa-exclamation-circle"/> &nbsp;
           <b>
           As the creator of this invitation, you choose when to move it
           to the next stage.
           </b>
         </p>
           <ol style={{padding : '0 0px 0 16px'}}>
              <li>Check who has responded at the top of this page.</li>
              <li>Once you're happy with the number of replies, press the button below. </li>
           </ol>
            <div>
              <button className="btn btn-block btn-primary"
              onClick={this.props.moveToNextStage}
              >
